...
%install
install -d %{buildroot}/opt/meeting-recorder/src
cp -r src/. %{buildroot}/opt/meeting-recorder/src/
install -m 644 requirements.txt %{buildroot}/opt/meeting-recorder/requirements.txt

install -Dm 755 packaging/usr/bin/meeting-recorder \
    %{buildroot}%{_bindir}/meeting-recorder
install -Dm 644 packaging/usr/share/applications/meeting-recorder.desktop \
    %{buildroot}%{_datadir}/applications/meeting-recorder.desktop

%files
%dir /opt/meeting-recorder
/opt/meeting-recorder/src/
