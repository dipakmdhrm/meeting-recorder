...
- **Meetings browser** — browse and read past transcripts and notes, each listed with the day of the week, date, time, and duration (same format as the Linux Library); rename or delete meetings
