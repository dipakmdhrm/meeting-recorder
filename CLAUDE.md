...
- `MeetingFormatTest` — covers `formatMeetingDate`/`formatDuration`/`formatMeetingSubtitle` (weekday prefix, 12-hour time, hours-vs-minutes duration, duration omitted when unknown, locale sensitivity) with the default locale pinned
