...
install_deps_apt() {
    ...
    sudo apt-get install -y python3 python3-venv python3-gi python3-gi-cairo gir1.2-gtk-4.0 gir1.2-adw-1 libadwaita-1-0 libnotify4 libnotify-bin ffmpeg pulseaudio-utils pipewire-pulse 2>/dev/null || true
