"""
Provides thread-safe wrappers for interacting with the GLib main loop. These utilities ensure that
UI updates from background threads are correctly scheduled on the GTK main thread.
"""
